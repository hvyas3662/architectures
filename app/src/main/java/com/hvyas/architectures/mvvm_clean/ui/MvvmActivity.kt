...
class MvvmActivity : ComponentActivity() {
    ...
    @Composable
    private fun CreateForm(modifier: Modifier = Modifier, onSubmit: (CleanMvvmExpense) -> Unit) {
        ...
        Column(
            ...
            Button(onClick = {
                val expanse = CleanMvvmExpense(0, dateText, timeText, amount.toDouble(), remark)
                dateText = ""
                timeText = ""
                amount = ""
                remark = ""
    ...
    @Composable
    private fun CreateList(modifier: Modifier = Modifier, itemList: List<CleanMvvmExpense>, onDelete: (Int) -> Unit) {
