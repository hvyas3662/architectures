...
class MvvmActivity : ComponentActivity() {
    ...
    private val mvvmViewModel: MvvmViewModel by viewModels<MvvmViewModel>()
    ...
    @Composable
    private fun CreateForm(modifier: Modifier = Modifier, onSubmit: (MvvmExpense) -> Unit) {
        ...
        Column(
            ...
            Button(onClick = {
                val expanse = MvvmExpense(0, dateText, timeText, amount.toDouble(), remark)
                dateText = ""
                timeText = ""
                amount = ""
                remark = ""
    ...
    @Composable
    private fun CreateList(modifier: Modifier = Modifier, itemList: List<MvvmExpense>, onDelete: (Int) -> Unit) {
